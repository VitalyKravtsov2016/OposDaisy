...
// PASTLWTR : 1.2
// File generated on 15.05.2026 8:52:49 from Type Library described below.

// ************************************************************************  //
// Type Lib: D:\projects\IBTS\OposDaisy\src\OposDaisy\OposDaisy.tlb (1)
// LIBID: {DE419508-17BD-42CD-AB6D-B719B31EDE02}
// LCID: 0
// Helpfile: 
// HelpString: OPOS Daisy Library
// DepndLst: 
...
const
  ...
  OposDaisyLibMajorVersion = 1;
  OposDaisyLibMinorVersion = 0;

  LIBID_OposDaisyLib: TGUID = '{DE419508-17BD-42CD-AB6D-B719B31EDE02}';

  IID_IFiscalPrinterService_1_12: TGUID = '{BB37EC5D-5328-4D40-90D6-8CE296ADB247}';
  CLASS_FiscalPrinter: TGUID = '{8DCFAFFA-228A-4E37-ACC2-FF9E1DC8A675}';
type
...
// GUID:      {BB37EC5D-5328-4D40-90D6-8CE296ADB247}
// *********************************************************************//
  IFiscalPrinterService_1_12 = interface(IDispatch)
    ['{BB37EC5D-5328-4D40-90D6-8CE296ADB247}']
