...
// LCID: 0
// Helpfile: 
// HelpString: OPOS Datecs Library
// DepndLst: 
...
const
  ...
  OposDatecsLibMajorVersion = 1;
  OposDatecsLibMinorVersion = 0;

  LIBID_OposDatecsLib: TGUID = '{DE419508-17BD-42CD-AB6D-B719B31EDE02}';
