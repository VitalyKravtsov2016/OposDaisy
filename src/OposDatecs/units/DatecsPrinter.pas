...
By default is “0”.
“0” or “1” > executes daily financial Z report (with clearing).
The reports ends with text “ÔÈÑÊÀËÅÍ ÁÎÍ” / “FISCAL RECEIPT” or
“ÍÅÔÈÑÊÀËÅÍ ÁÎÍ” / “NON-FISCAL RECEIPT” (depends if FD is fiscalized).
“2” or “3” > executes daily financial X report (without clearing).
The reports ends with text “ÑËÓÆÅÁÅÍ ÁÎÍ” / “SERVICE BON” or
“ÍÅÔÈÑÊÀËÅÍ ÁÎÍ” / “NON-FISCAL RECEIPT” (depends if FD is fiscalized).
“5” > In case of full FD’s EJ, FD prints EJ content.
...
“6” > executes daily financial Z report (with clearing) without printing on paper,
but write it in EJT and FM (if FD is fiscalized).
“8” > executes periodic financial Z report by departments.
No data is returned.
“9” > executes periodic financial X report by departments.
No data is returned.
*)
...
resourcestring
  SInvalidPreambule = 'Íåâåðíîûé êîä ïðåàìáóëû';
...
Tax1…Tax8 Sales total/net amount by tax group “À”…”Ç”.
StTax1…StTax8 Refund total/net amount by tax group “À”…”Ç”.
*)
